...
<body class="w3-light-grey">
	<div class="w3-content mxw700 w3-margin-top">
		...
		<header class="w3-col w3-card-4 mgb20">
			<h1 class="w3-pink w3-center w3-padding mg0">BlackPink 파일게시판</h1>
...
<c:if test="${not empty SID}">
		...
		<div class="w3-col w3-white w3-padding w3-card-4 w3-center">
			<div class="w3-col w3-light-grey w3-border-bottom"">
				<div class="w3-col m3">
