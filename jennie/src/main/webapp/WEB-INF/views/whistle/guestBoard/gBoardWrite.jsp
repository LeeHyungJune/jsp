	...
	<!-- 페이지 헤더 -->
		...
		<form method="post" action="/whistle/guestBoard/gBoardWriteProc.blp" name="frm" id="frm" 
				...
				<div class="w3-col box120 pdAll10 w3-border-right w3-border-deep-orange">
					<img src="/whistle/resources/img/avatar/noimage.jpg" class="inblock avtBox100 w3-border w3-border-grey">
				</div>
		...
		<div class="w3-col w3-card-4">
			<div class="w3-third w3-button w3-green w3-hover-lime">list</div>
			<div class="w3-third w3-button w3-amber w3-hover-yellow">reset</div>
			<div class="w3-third w3-button w3-deep-orange w3-hover-aqua">글등록</div>
		</div>
	</div>
</body>
</html>